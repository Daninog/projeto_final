# Senhas, usuários, host, caminhos e IP's foram omitidos no código
...
def cria_e_retorna_enderecos_dos_diretorios(diretorio):
    try:
        ...
        caminho_raiz = r"insira o caminho"
...
def info_postgre():
    try:
        ...
        usuario_postgre = "insira o usuário"
        senha_postgre = "insira a senha"
        host = "insira o host"
...
def info_cassandra():
    try:
        ...
        ip_externo = "insira o ip externo"
